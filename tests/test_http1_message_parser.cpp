...
TEST_CASE("Parse http method", "[parse_http_request]") {
  ...
  //   string method = "HEAD ";
  //   CHECK(parser.Parse({method.data(), method.size()}, ec) == method.size() - 1);
  ...
  //   CHECK(parser.request_line_state_ == RequestParser::RequestLineState::kSpacesBeforeUri);
  // }
  //
  ...
  // }
  //
  // SECTION("Parse valid DELETE method string should return HttpMethod::kDelete") {
  ...
  // }
  //
  // SECTION("Parse valid CONTROL method string should return HttpMethod::kControl") {
  ...
  // }
  //
  // SECTION("Parse valid OPTIONS method string should return HttpMethod::kOptions") {
  ...
  // }
  //
  // SECTION("Parse valid CONNECT method string should return HttpMethod::kConnect") {
  ...
  //   CHECK(ec == Error::kNeedMore);
  //   CHECK(parser.message_state_ == RequestParser::MessageState::kStartLine);
  //   CHECK(parser.request_line_state_ == RequestParser::RequestLineState::kMethod);
  //
  //   ec.clear();
  //   method.push_back('O');
  //   CHECK(parser.Parse({method.data(), method.size()}, ec) == 0);
...
//
//     CHECK(parser.message_state_ == RequestParser::MessageState::kStartLine);
//     CHECK(parser.request_line_state_ == RequestParser::RequestLineState::kSpacesBeforeHttpVersion);
//   }
//
...
//     CHECK(parser.message_state_ == RequestParser::MessageState::kExpectingNewline);
//   }
//
...
//     CHECK(parser.Parse(buffer, ec) == buffer.size());
//     CHECK(ec == Error::kNeedMore);
//     CHECK(parser.message_state_ == ResponseParser::MessageState::kExpectingNewline);
//     CHECK(rsp.version == HttpVersion::kHttp11);
//     CHECK(rsp.status_code == HttpStatusCode::kOK);
//     CHECK(rsp.reason == "OK");
//   }
